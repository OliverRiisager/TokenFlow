...
export class traceProcessor {
   ...
   extendWeb3(_web3Instance: Web3) : Web3 {
    ...
    async doGetTransfers(txHash:string) : Promise<{ transfers: Transfer[], nodes:{address: string | null | undefined, name:string | null | undefined}[] }>{
            ...
            var decodedLogJsonString = JSON.stringify(abiDecoder.decodeLogs(receipt.logs));
            let decodedLogs : DecodedLog[] = DecodedLogConvert.toDecodedLog(decodedLogJsonString);
            if(decodedLogs === null){
