...
export const tokenAddressToSymbolDecimals: TokenAddressToSymbolDecimal =
    new TokenAddressToSymbolDecimal();
tokenAddressToSymbolDecimals.AddTokenAddressSymbolDecimal(
    'unknown',
    new SymbolDecimal('unknown', 18)
);
tokenAddressToSymbolDecimals.AddTokenAddressSymbolDecimal(
    '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
    new SymbolDecimal('WETH', 18)
);
tokenAddressToSymbolDecimals.AddTokenAddressSymbolDecimal(
    '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
    new SymbolDecimal('ETH', 18)
);
tokenAddressToSymbolDecimals.AddTokenAddressSymbolDecimal(
    '0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2',
    new SymbolDecimal('MKR', 18)
);

export const contractAddressToNames: ContractAddressToNames =
    new ContractAddressToNames();
